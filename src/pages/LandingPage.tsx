// src/pages/LandingPage.tsx â€” VoxMeet
...
// Planos ativos para exibiÃ§Ã£o na landing
const LANDING_PLANS = [
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white overflow-x-hidden font-sans">
      ...
      <section className="relative pt-24 pb-32 px-6">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <span>Powered by Groq Whisper â€” transcriÃ§Ã£o ultrarrÃ¡pida</span>
          </motion.div>
          ...
          >
            Grave reuniÃµes, transcreva com IA em segundos e extraia resumos,
          ...
          >
            ...
            <p className="text-sm text-white/30 font-mono">Sem cartÃ£o de crÃ©dito</p>
          </motion.div>
      ...
      <section className="py-24 px-6 bg-[#030303] border-t border-white/5">
        <div className="max-w-6xl mx-auto space-y-16">
          <div className="text-center space-y-4 max-w-2xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-serif italic text-white">Tudo que vocÃª precisa</h2>
            <p className="text-xl text-white/40 font-light">Para extrair o mÃ¡ximo de cada reuniÃ£o.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="col-span-1 md:col-span-2 bg-[#080808] border border-white/5 rounded-[32px] p-8 md:p-12 relative overflow-hidden group hover:border-white/10 transition-all">
              ...
              <div className="relative z-10">
                ...
                <p className="text-white/50 leading-relaxed mb-6">
                  Grave sua chamada com o app de gravaÃ§Ã£o do celular, faÃ§a upload do Ã¡udio e o VoxMeet
                  transcreve tudo com precisÃ£o. CompatÃ­vel com MP3, M4A, WAV, OGG e WebM.
                </p>
            ...
            <div className="bg-[#080808] border border-white/5 rounded-[32px] p-8 relative overflow-hidden group hover:border-white/10 transition-all">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-2xl font-bold text-white mb-4">Chat com a ReuniÃ£o</h3>
            ...
            <div className="bg-[#080808] border border-white/5 rounded-[32px] p-8 relative overflow-hidden group hover:border-white/10 transition-all">
              ...
              <div className="relative z-10">
                ...
                <p className="text-white/50 leading-relaxed">
                  O modelo de transcriÃ§Ã£o mais rÃ¡pido do mundo. Resultados em segundos,
                  com suporte nativo ao portuguÃªs brasileiro.
                </p>
              </div>
            </div>
            ...
            <div className="col-span-1 md:col-span-2 bg-[#080808] border border-white/5 rounded-[32px] p-8 md:p-12 relative overflow-hidden group hover:border-white/10 transition-all">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-2xl font-bold text-white mb-4">Resumo + Action Items automÃ¡ticos</h3>
                <p className="text-white/50 leading-relaxed">
                  ApÃ³s cada reuniÃ£o, o LLaMA 70B gera um resumo executivo e lista as tarefas identificadas â€”
                  tudo salvo automaticamente no histÃ³rico.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-24 px-6 relative">
        <div className="max-w-5xl mx-auto space-y-12">
          <div className="text-center space-y-4">
            ...
            <p className="text-white/40">Comece grÃ¡tis, faÃ§a upgrade quando precisar</p>
          </div>
                ...
                >
                  ...
                  <div>
                    <p className="text-2xl font-bold text-white">
                      {p.priceMonthlyBRL === 0 ? 'GrÃ¡tis' : `R$ ${p.priceMonthlyBRL.toFixed(2)}`}
                    </p>
                    <p className="text-xs text-white/30">
                      {p.priceMonthlyBRL === 0 ? 'para sempre' : '/mÃªs'}
                    </p>
                  </div>
                  ...
                  >
                    {p.priceMonthlyBRL === 0 ? 'ComeÃ§ar grÃ¡tis' : 'Assinar'}
                  </button>
                </div>
              );
            })}
      ...
      <section className="py-24 px-6 bg-[#030303] border-t border-white/5">
        <div className="max-w-5xl mx-auto text-center space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
            {[
              { icon: <Clock />, title: 'Economize horas', desc: 'Sem anotar atas manualmente. A IA cuida de tudo enquanto vocÃª foca na conversa.' },
              { icon: <MessageSquare />, title: 'Fale com a reuniÃ£o', desc: 'Pergunte qualquer coisa sobre o que foi discutido em linguagem natural.' },
              { icon: <Shield />, title: 'Seus dados, sua chave', desc: 'No plano Power, use sua prÃ³pria chave API. Zero dependÃªncia de terceiros.' },
            ].map((f, i) => (
      ...
      <footer className="py-8 px-6 border-t border-white/10 text-center text-white/20 text-sm">
        <p>Â© 2026 VoxMeet. Todos os direitos reservados.</p>
